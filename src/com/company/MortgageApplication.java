...
public class MortgageApplication {
	...
	public MortgageApplication(String newAccountType, int newCustomerId, Database db){
		rc = interview();
		mortgageConditions();
		makeMortage();
	}
	...
	private void makeMortage(){
		...
		Mortgage m = new Mortgage(String newAccountType, int newCustomerId, Database db);
